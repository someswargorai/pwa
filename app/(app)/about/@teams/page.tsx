...
export default function page() {
  return (
    <div className="w-full h-full flex flex-col pt-10 pl-2 pb-2">
      ...
      <div className="flex flex-col gap-1">
        ...
        {['Engineering', 'Product Design', 'Marketing', 'Sales'].map((team, i) => (
          <Link href={`/about/${team}`} key={i} className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-zinc-300 hover:text-white hover:bg-white/10 transition-colors w-full text-left">

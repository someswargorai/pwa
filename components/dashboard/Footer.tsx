export default function Footer() {
  return (
    <footer className="relative z-10 w-full max-w-2xl lg:max-w-full mx-auto px-5 lg:px-10 py-8 mt-4 mb-2 flex flex-col items-center justify-center text-center">
